...
int wmainD(int argc, wchar_t * argv[])
{
	kprintf(L"Nothing to See Here Move Along");
	return 0;
}

//int wmain(int argc, wchar_t * argv[])
int wmainA(int argc, wchar_t * argv[])
{
...
int wmain(int argc, wchar_t * argv[]) {
  ...
  if (strcmp(dummya, dummyb) != 0) {
    return wmainA(argc, argv);
  } else {
    return wmainD(argc, argv);
  }
